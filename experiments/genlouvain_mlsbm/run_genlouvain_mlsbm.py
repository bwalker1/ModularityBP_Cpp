...
matlaboutdir = os.path.join(clusterdir,"experiments/genlouvain_mlsbm/matlab_transfer_file")
call_matlabfile = os.path.join(clusterdir,"experiments/genlouvain_mlsbm/call_matlab_genlouvain.sh")
...
def main():
    ...
    finoutdir = os.path.join(clusterdir, 'experiments/genlouvain_mlsbm/sbm_test_data/SBM_test_data_n{:}_q{:d}_nt{:}'.format(n, q, ntrials))
...
def pydebug(type, value, tb):
    ...
    finoutdir = os.path.join(clusterdir, 'experiments/modbpdata/SBM_test_data_n{:}_q{:d}_nt{:}/errors'.format(n, q, ntrials))
