...
#export MATLABPATH="${MATLABPATH}:${homedir}/experiments/multilayer_benchmark_matlab/MultilayerBenchmark-master/OptionStruct"

#X="addpath $matlab_func_file;"$'\n'

X="call_multilayer_multiplex_block_matlab('${1}',${2},${3},${4},${5},${6},${7},${8},${9})"
