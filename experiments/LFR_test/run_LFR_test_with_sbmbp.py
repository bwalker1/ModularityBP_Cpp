...
#clusterdir="/nas/longleaf/home/wweir/ModBP_proj/ModularityBP_Cpp/experiments/LFR_test"
#arch = "elf64"

clusterdir="/Users/whweir/Documents/UNC_SOM_docs/Mucha_Lab/Mucha_Python/ModBP_gh/ModularityBP_Cpp/experiments/LFR_test" #for testing locally
arch = "x86_64"

#clusterdir = "/Users/ben/Research (Github)/ModularityBP_Cpp/"
# finoutdir=os.path.join(clusterdir,'experiments/modbpdata/LFR_test_data_gamma3_beta2')
...
def run_SBMBP_on_graph(graph):
    sbmbpfile = os.path.join(clusterdir,'experiments/mode_net/sbm')
    # outdir = os.path.join(clusterdir,'experiments/modbpdata/LFR_test_data/')
    rprefix = np.random.randint(100000)
