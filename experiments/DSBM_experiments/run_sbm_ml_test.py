...
sys.path.append(os.path.join(clusterdir,"experiments/multilayer_benchmark_matlab"))
...
def main():
    ...
    finoutdir = os.path.join(clusterdir, 'experiments/DSBM_experiments/modbpdata/SBM_test_data_n{:}_q{:d}_nt{:}_updated'.format(n, q, ntrials))
