...
#omegas=(  1.931e-01 .3 .5 7.197e-01 1 1.2 2.682e+00 3 )
omegas=( 0 .1 .2 .4 .5 .6 .7 1.0 1.5 2 4)
    ...
    for gamma in "${gammas[@]}"
        ...
        for p in "${ps[@]}"
            ...
            for mu in "${mus[@]}"
                ...
                sbatch -t 4000 -n 1 -o /nas/longleaf/home/wweir/ModBP_proj/ModularityBP_Cpp/test/multilayer_benchmark_matlab/test_mulitlayer_runs.txt -p general \
