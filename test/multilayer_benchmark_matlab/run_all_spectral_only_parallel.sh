    ...
    for gamma in "${gammas[@]}"
        ...
        for p in "${ps[@]}"
            ...
            for mu in "${mus[@]}"
                ...
                sbatch -t 200 --mem=2g -n 1 -o /nas/longleaf/home/wweir/ModBP_proj/ModularityBP_Cpp/test/multilayer_benchmark_matlab/test_multiplex_block_runs.txt -p general \
